      ...
      {data?.elections?.map((election) => {
        ...
        return (
          <div key={election._id} className="w-full">
            <div className="h-[10vh] w-full flex justify-between px-12 items-center bg-gradient-to-l from-white via-sky-200 to-sky-600 shadow-md rounded-md">
              <p className="cal-sans text-4xl tracking-wide text-white">{election.name}</p>
              <p className="cal-sans text-2xl tracking-wider">
                Election Date : {format(election.startDate, "dd MMMM yyyy")}
              </p>
            </div>
            <div className="w-full h-[75vh] flex gap-4 mt-3">
              <div className="w-[75%] rounded-md bg-gray-700/50">
              ...
              <div className="w-[25%] h-full rounded-md bg-gray-700/50">
                <div className="w-full border-b-[1px] py-2 px-4">
